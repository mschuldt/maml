...
OP_SET = OP("OP_SET")
OP_GET = OP("OP_GET")
OP_BLOCK_NEXT = OP("OP_BLOCK_NEXT")
OP_BLOCK_SUICIDE = OP("OP_BLOCK_SUICIDE")
OP_PAUSE = OP("OP_PAUSE")
OP_RESUME = OP("OP_RESUME")
OP_DUMP_STACK = OP("OP_DUMP_STACK")
...
SOP_STR = OP("SOP_STR")
SOP_ARRAY = OP("SOP_ARRAY")  # void*
SOP_INT_ARRAY = OP("SOP_INT_ARRAY")
